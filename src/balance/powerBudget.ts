...
export const CHAPTER_POWER: Readonly<Record<number, ChapterPowerAnchor>> = {
  ...
  4: { chapter: 4, enterLevel: 40, enterStar: 3, clearLevel: 52 },
  5: { chapter: 5, enterLevel: 52, enterStar: 4, clearLevel: 62 },
  6: { chapter: 6, enterLevel: 62, enterStar: 4, clearLevel: 72 },
  7: { chapter: 7, enterLevel: 72, enterStar: 4, clearLevel: 82 },
  8: { chapter: 8, enterLevel: 82, enterStar: 5, clearLevel: 92 },
};
