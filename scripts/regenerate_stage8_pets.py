...
PETS: list[tuple[str, str, str]] = [
    ("pet_001", "Young iron rhino cub with slate-gray plates and cream belly, stubby horn, amber eyes, small bronze nose ring, cracked metal shoulder plates like baby armor, short tail. Battle pose: lowered head showing back plates.",
    ...
    ("pet_002", "Elegant sword-fox girl beast with silver fur, one small katana hairpin in fox topknot, sharp golden eyes, white and indigo robes with metal trim, slim fluffy tail with silver tip. Cute focused expression.",
    ...
    ("pet_003", "Small vine archer squirrel with moss-green fur, tiny living-wood crossbow on back, acorn quiver, leaf bandana, bright hazel eyes, fluffy tail with vine wrap. Playful alert expression.",
    ...
    ("pet_004", "Gentle fawn healer with soft jade-green eyes, small antler nubs, leaf crown, herb pouch at neck, cream and sage fur, pink nose, dewdrop earrings. Serene caring smile.",
    ...
    ("pet_005", "Delicate ice crane chick with powder-blue wing tips, tiny crystal crest on head, round sapphire eyes, silver leg bands, soft white-gray feathers, small bell on ribbon. Graceful shy expression.",
    ...
    ("pet_006", "Small ice dragon cub with pearlescent blue scales, stubby horns, big teal eyes, tiny fin-wings, cloud-white belly, ice crystal on chest. Proud curious expression.",
    ...
    ("pet_007", "Fluffy orange fire fox with cream muzzle, ember-orange tail tip, copper eyes, small flame-shaped ear charms, tiny red scarf. Mischievous bright smile.",
    ...
    ("pet_008", "Young demon fox warrior with dark crimson fur, small black horns, golden eyes, lightweight black-red armor plates, flame mark on cheek, short cape. Fierce but cute.",
    ...
    ("pet_009", "Round stone bear cub with sandy-brown fur, rocky shoulder pads, tiny crystal in chest, amber eyes, earthen clay collar tag. Sturdy stubborn expression.",
    ...
    ("pet_010", "Gentle clay mouse priestess with warm brown fur, earthen pot charm necklace, soft pink ears, amber eyes, simple hemp ribbon, tiny flower on head. Kind nurturing smile.",
